...
public:
	...
	void Output_SurfaceInformation(const vk::PhysicalDevice& physicalDevice, const vk::SurfaceKHR& surface, const Dispatch& vkDynLoader)
	{
	...
	template<typename Dispatch>
	void Output_PhysicalDevices(const vk::Instance& inst, bool getProperties2, const Dispatch& vkDynLoader)
	{
		std::stringstream buf;
