			...
			if(_inPATHSet AND DEFINED _currentPATHSet_PATHS)
				...
				foreach (_path ${_currentPATHSet_PATHS})
					list(APPEND _COMMAND_LIST
						...
						${CMAKE_COMMAND} -DSOURCE=${_path} -DDEST_DIR=${_parsedArguments_OUTPUT} -P ${_THIS_MODULE_BASE_DIR}/EnscriptenCompressZipCopy.cmake
					)
					set(_dependPath "${_currentPATHSet_WORKINGDIR}/${_path}")
#					list(APPEND _COMMAND_LIST
#						COMMAND
#						${CMAKE_COMMAND} -DSOURCE=${_dependPath} -DDEST_DIR=${_parsedArguments_OUTPUT} -P ${_THIS_MODULE_BASE_DIR}/EnscriptenCompressZipCopy.cmake
#					)
