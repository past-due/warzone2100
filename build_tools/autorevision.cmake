...
elseif(Git_FOUND AND _currentDirectoryIsInGitRepo)
	...
	execute_process( COMMAND ${GIT_EXECUTABLE} for-each-ref refs/tags/ --format "%(objecttype) %(refname:short)" --sort=-taggerdate
					 ...
					 OUTPUT_STRIP_TRAILING_WHITESPACE ERROR_QUIET)
	if(exstatus EQUAL 0)
		string(REPLACE ";" "_SEMICOLON_" _ordered_tags_with_type "${_ordered_tags_with_type}")
	...
	list(FIND _ordered_annotated_tags "${VCS_MOST_RECENT_TAGGED_VERSION}" _index_of_tag)
	...
	if(NOT VCS_TAG STREQUAL "")
		...
		list(FIND _ordered_annotated_tags "${VCS_TAG}" _index_of_tag)
		if (NOT _index_of_tag EQUAL -1)
