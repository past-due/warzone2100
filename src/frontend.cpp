...
#else
		wzDisplayDialog(Dialog_Information, "Multiplayer requires the native version.", "The web version of Warzone 2100 does not support multiplayer. Please visit https://wz2100.net to download the native version for your platform.");
#endif
		break;
