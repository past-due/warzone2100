...
struct STRUCTURE_STATS : public BASE_STATS
{
	...
	std::vector<const iIMDShape *> pIMD;  // The IMDs to draw for this structure, for each possible number of modules.
	const iIMDShape *pBaseIMD;            /*The base IMD to draw for this structure */
