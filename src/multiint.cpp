...
static void informIfAdminChangedOtherTeam(uint32_t targetPlayerIdx, uint32_t responsibleIdx)
{
	...
	debug(LOG_INFO, "Admin ([%u] %s) changed team of player ([%u] %s) to: %d", responsibleIdx, NetPlay.players[responsibleIdx].name, NetPlay.players[targetPlayerIdx].position, NetPlay.players[targetPlayerIdx].name, NetPlay.players[targetPlayerIdx].team);
}
...
static void informIfAdminChangedOtherPosition(uint32_t targetPlayerIdx, uint32_t responsibleIdx)
{
	...
	debug(LOG_INFO, "Admin ([%u] %s) changed position of player (%s) to: %d", responsibleIdx, NetPlay.players[responsibleIdx].name, NetPlay.players[targetPlayerIdx].name, NetPlay.players[targetPlayerIdx].position);
}
...
static void informIfAdminChangedOtherColor(uint32_t targetPlayerIdx, uint32_t responsibleIdx)
{
	...
	debug(LOG_INFO, "Admin ([%u] %s) changed color of player ([%u] %s) to: [%d] %s", responsibleIdx, NetPlay.players[responsibleIdx].name, NetPlay.players[targetPlayerIdx].position, NetPlay.players[targetPlayerIdx].name, NetPlay.players[targetPlayerIdx].colour, getPlayerColourName(targetPlayerIdx));
}
...
static void informIfAdminChangedOtherFaction(uint32_t targetPlayerIdx, uint32_t responsibleIdx)
{
	...
	debug(LOG_INFO, "Admin ([%u] %s) changed faction of player ([%u] %s) to: %s", responsibleIdx, NetPlay.players[responsibleIdx].name, NetPlay.players[targetPlayerIdx].position, NetPlay.players[targetPlayerIdx].name, to_localized_string(static_cast<FactionID>(NetPlay.players[targetPlayerIdx].faction)));
}
