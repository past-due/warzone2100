...
namespace INTERNAL_LOBBY_COMMAND_RESPONSE {
	...
	static std::string helpText(bool isAdmin)
	{
		...
		result += "\n";
		result += astringf(_("%shelp - Get this message"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%sadmin - Display currently-connected admin players"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%sme - Display your information"), LOBBY_COMMAND_PREFIX);
		if (!isAdmin)
		{
			result += "\n";
		...
		result += "\n";
		result += astringf(_("%sswap <slot-from> <slot-to> - Swap player/slot positions"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%smakespec <slot> - Move a player to spectators"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%smakeplayer s<slot> - Request to move a spectator to players"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%skick <slot> - Kick a player; (or s<slot> for spectator - ex. s0)"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%steam <slot> <team> - Change team for player/slot"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%sbase <base level> - Change base level (0, 1, 2)"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%salliance <alliance type> - Change alliance setting (0, 1, 2, 3)"), LOBBY_COMMAND_PREFIX);
		result += "\n";
		result += astringf(_("%sscav <scav level> - Change scav setting (0=off, 1=on, 2=ultimate)"), LOBBY_COMMAND_PREFIX);
		return result;
	}
